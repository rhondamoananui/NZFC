...
<!-- .banner contains the cover image, profile img and username -->
				...
				<div class="right-box">
					...
					<?php 
						...
						if($userID==TRUE){
							...
							echo form_open_multipart('mypage/make_comment?id='.$userID);?>
...
#								
						  ...
						  //   	echo '</div>';
					    	...
					    	echo '</div>';
					    		...
					    		// Get the id for each 'post'	
					    		// Get all the comments that match the "post" id
					    		// Loop through all comments for each post
...
#	
										// if the $result array has data, display the comment box
										if($result==!NULL){
...
#
		                    ...
		                    echo '<input type="hidden" class="hide" placeholder="Post a Comment" name="post_id" value="'.$post_id.'">';
		...
		<aside class="sponsored-ads"></aside>
