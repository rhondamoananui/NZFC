          ...
          <a href="#" class="list-group-item  charter-groups">
           ...
           <!-- <a href="#" class=" "> -->
                       <?php
                            ...
                            'src'   => 'assets/img/charter/'.$value->main_img,
                            'alt'   => 'NZ Fishing Club',
           ...
           <!--  </a> -->
            <div class="list-group-item charter-contact">
                <p class="resource-p"><?php echo $value->description ?></p>
        
                


                <div class="charter-button">
                    <?php echo anchor('resources/campground?id='.$value->id, 'More', 'class="btn btn-primary more-button"'); ?>
...
?>
       ...
       <!--  -->
        ...
        <div class="col-lg-9">
            <p>Add Your <?php echo anchor(base_url('resources/new_campground'),'Campground Listing'); ?></p>
        </div>
